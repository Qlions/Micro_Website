    ...
    $.fn.esign = function(canvasEdit, sign_show, sign_clear, sign_ok) {
        ...
        */
        ...
        function convertCanvasToImage(canvas){
            ...
            //return image;
            console.log(canvas.toDataURL("i/png"));
            
            
            //base 64
            sessionStorage.canvasImg = canvas.toDataURL("i/png");
//          $("#autograph").hide();

			
			var a = getBlobBydataURI(canvas.toDataURL("i/png"), 'image/jpeg');
			console.log(a);
			sessionStorage.canvasFile = a;
        }
