	...
	<div class="header_content">
		<!-- <div class="if_jupage" v-if="!eaId">
			...
			<div class="head_content_box">
				...
				<header>
					<b :class='{active}' @click="backBtn" v-if="eid">
		...
		<div v-else>
			<div class="head_null" style="width:100%;height:.84rem;" ref="head_null"></div>
			<div class="head_content_box">
				<header>
					<b :class='{active}' @click="backBtn" v-if="eid">
						<img src="../../assets/image/head-back.png" alt="返回图标">
		...
		/*mounted () {
			if(!this.eaId){
				if(sessionStorage.getItem('key_head') == 1){
					this.isHead = false;
					this.$refs.head_null.style.height = .84+'rem';
				}else {
					this.isHead = true;
